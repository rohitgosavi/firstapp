      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>{customerEntity.customerAddress}</dd>
            <dt>
              <span id="customerEmail">Customer Email</span>
            </dt>
            <dd>{customerEntity.customerEmail}</dd>
            <dt>
              <span id="customerContact">Customer Contact</span>
            </dt>
            <dd>{customerEntity.customerContact}</dd>
          </dl>
